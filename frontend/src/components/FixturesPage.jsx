          ...
          {matches.map(match => (
            <div key={match._id} className="bg-white rounded-2xl shadow-lg p-6 flex flex-col gap-4 hover:scale-[1.03] transition-transform duration-200 border border-indigo-100">
              <div className="flex items-center gap-4">
                <img src={reactLogo} alt="Home Team Logo" className="h-10 w-10 rounded-full border-2 border-blue-300 bg-blue-50" />
                ...
                <img src={reactLogo} alt="Away Team Logo" className="h-10 w-10 rounded-full border-2 border-indigo-300 bg-indigo-50" />

    ...
    <div className="max-w-5xl mx-auto p-8">
              ...
              <tr key={u._id}>
                ...
                <td className="p-2 border-t">
                  <button className="px-3 py-1 bg-red-500 text-white rounded" onClick={async () => {
                    await axios.delete(`/api/admin/users/${u._id}?admin=true`);
          ...
          <tbody>
            {players.map(p => (
              <tr key={p._id}>
                ...
                <td className="p-2 border-t">
                  <button className="px-3 py-1 bg-red-500 text-white rounded" onClick={async () => {
                    await axios.delete(`/api/admin/players/${p._id}?admin=true`);
          ...
          <tbody>
            {teams.map(t => (
              <tr key={t._id}>
                ...
                <td className="p-2 border-t">
                  <button className="px-3 py-1 bg-red-500 text-white rounded" onClick={async () => {
                    await axios.delete(`/api/admin/teams/${t._id}?admin=true`);
      ...
      <section className="mb-12">
        ...
        <form className="mb-6 flex flex-wrap gap-2 items-center" onSubmit={async e => {
          ...
          setMatchError('');
          try {
            const res = await axios.post('/api/match', matchForm);
              ...
              <tr key={match._id}>
                ...
                <td className="p-2 border-t">
                  <button className="px-2 py-1 bg-red-500 text-white rounded" onClick={async () => {
                    await axios.delete(`/api/match/${match._id}`);
